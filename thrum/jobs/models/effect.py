...
instrumenting the Scope's session and written into Txn 2 (ADR-0024).
...
rows. Effects key off the Attempt: a failed Attempt's writes roll back with Txn 2
and contribute zero Effects, so a retry's Effects attribute to the retry.
